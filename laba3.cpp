...
int main() {
    ...
    cout << "b) Массив с инициализацией:" << endl;
    ...
    cout << "c) Сокращенная форма инициализации массива:" << endl;
    ...
    cout << "4. Константные объекты:" << endl;
    cout << "========================" << endl;
    ...
    cout << "5. Передача объектов в функции:" << endl;
    cout << "================================" << endl;
    
    // 16. Передача по значению (вызывается конструктор копирования)
    cout << "a) Передача по значению:" << endl;
    ...
    cout << "6. Операции над векторами:" << endl;
    cout << "===========================" << endl;
    ...
    cout << "7. Освобождение динамической памяти:" << endl;
    cout << "===================================" << endl;
    ...
    cout << "Демонстрация метода toString(): " << a.toString() << endl;
